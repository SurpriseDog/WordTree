...
## Install:
 ...
 2. Choose your language and run with: ./wordtree.py --lang (abbreviation) (Language Name)
   ...
   - The first run will take many minutes to scan the entire 2 Gigabyte Wiktionary dump file and process it into a sqlite database inside the cache folder. After that, the program will start in a few seconds everytime, unless you run it with a different language code.
